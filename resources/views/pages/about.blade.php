    ...
    <div class="why-choose-section">
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6">
                    <h2 class="section-title">Kenapa LuxBliss Vogue?</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
                    <img src="{{asset('asset/team/rama.jpeg')}}" class="img-fluid mb-5" style="border-radius: 100%;">
                    <h3 class="text-center">
                        <a href="#">R. Muhamad Rama Poetra A</a>
                    </h3>
                    <span class="d-block position mb-4 text-center">Product Owner - Analys.</span>
                </div>
                <!-- End Column 1 -->

                <!-- Start Column 2 -->
                <div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
                    <img src="{{asset('asset/team/laeli.jpg')}}" class="img-fluid mb-5" style="border-radius: 100%">

                    <h3 class="text-center">
                        <a href="#">Laeli Jamilah</a>
                    </h3>
                    <span class="d-block position mb-4 text-center">Scrum Master - Quality Assurance.</span>
                </div>
                <!-- End Column 2 -->

                <!-- Start Column 3 -->
                <div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0">
                    <img src="{{asset('asset/team/dwi.jpg')}}" class="img-fluid mb-5" style="border-radius: 100%;">
                    <h3 class="text-center">
                        <a href="#">Dwi Pasha Anggara Putra</a>
                    </h3>
                    <span class="d-block position mb-4 text-center">UI/UX Designer - Programer.</span>
                </div>
                <!-- End Column 3 -->
